...
public class Meeting {
	...
	private byte piority;
        ...
        private final String sqlSelect = "SELECT * FROM meeting ";
        ...
        public Meeting(String title, int meetingId, String description,
                int host_id, LocalDateTime start_time, LocalDateTime end_time,
                LocalDate runs_until,int priority, String location, 
	...
	public String toSQL()
	{
        ...
        public int getIdFromDatabase() throws SQLException
        {
            ...
            String getMeetingId = "SELECT meeting_id FROM meeting "
                ...
                "AND repeteEvery = '" + this.repeatEvery.toString()+"'" +
    ...
    public int hashCode() 
    {
        ...
        hash = 47 * hash + Objects.hashCode(this.sqlSelect);
        return hash;
    }
    ...
    public boolean equals(Object obj) 
    {
        ...
        if (!Objects.equals(this.sqlSelect, other.sqlSelect)) {
            return false;
        }
        return true;
    }
